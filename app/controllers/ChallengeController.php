...
class ChallengeController {
    ...
    public function create() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (empty($errors)) {
                ...
                if ($success) {
                    header('Location: /challengehub/challenges?msg=create_success');
                    exit;
                }
    ...
    public function edit(int $id) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (empty($errors)) {
                ...
                if ($success) {
                    header('Location: /challengehub/challenges?msg=edit_success');
                    exit;
                }
    ...
    public function delete(int $id) {
        ...
        $challenge = Challenge::findById($id);
        if (!$challenge || $challenge->getUserId() !== (int)($_SESSION['user_id'] ?? 0)) {
            http_response_code(403);
            echo "<h1>403 - Accès non autorisé</h1>";
            exit;
        }
        ...
        header('Location: /challengehub/challenges?msg=delete_success');
        exit;
    }
    ...
    private function uploadImage(): string {
        ...
        $relativePath = "/challengehub/uploads/challenges/" . $fileName;
